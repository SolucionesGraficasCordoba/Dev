Public Class frm_Orden_Trabajo
    ...
    Private Sub btnGuardar_Orden_Trabajo_Click(sender As System.Object, e As System.EventArgs) Handles btnGuardar_Orden_Trabajo.Click
        ...
        If txt_cantidad1_detalle1.Text.Length >= 1 Then
            ...
            If frm_Procesos.txt_descripc_offset.TextLength = 0 Then
                frm_Procesos.groupOffSet.Text = ""
            Else
                proceso.PROC_offset = frm_Procesos.groupOffSet.Text
                proceso.PROC_descrip_offset = frm_Procesos.txt_descripc_offset.Text
            End If
            If frm_Procesos.txt_descripc_digital.TextLength = 0 Then
                frm_Procesos.groupDigital.Text = ""
            Else
                proceso.PROC_digital = frm_Procesos.groupDigital.Text
                proceso.PROC_descrip_digital = frm_Procesos.txt_descripc_digital.Text
            End If
            If frm_Procesos.txt_descripc_gran_formato.TextLength = 0 Then
                frm_Procesos.groupGranFormato.Text = ""
            Else
                proceso.PROC_gran_formato = frm_Procesos.groupGranFormato.Text
                proceso.PROC_descrip_gran_formato = frm_Procesos.txt_descripc_gran_formato.Text
            End If
            If frm_Procesos.txt_descripc_terminacion.TextLength = 0 Then
                frm_Procesos.groupTerminacion.Text = ""
            Else
                proceso.PROC_terminacion = frm_Procesos.groupTerminacion.Text
                proceso.PROC_descrip_terminacion = frm_Procesos.txt_descripc_terminacion.Text
            End If
            If frm_Procesos.txt_descripc_logistica.TextLength = 0 Then
                frm_Procesos.groupLogistica.Text = ""
            Else
                proceso.PROC_logistica = frm_Procesos.groupLogistica.Text
                proceso.PROC_descrip_logistica = frm_Procesos.txt_descripc_logistica.Text
            End If
