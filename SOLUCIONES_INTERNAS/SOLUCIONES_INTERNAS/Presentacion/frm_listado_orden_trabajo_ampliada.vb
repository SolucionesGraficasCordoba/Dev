...
Where ORT_id_orden_trabajo = vble_id_orden)
    ...
    Private Sub btnVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVer.Click
        ...
        If dgv_detalle_orden.SelectedRows.Count > 0 Then
            ...
            frm_Orden_Trabajo_Ampliada.txtNumero_Orden_Trabajo.Text = dgvLista_Orden_Trabajo.Item("ORT_numero_ot", dgvLista_Orden_Trabajo.SelectedRows(0).Index).Value 'numero orden
            frm_Orden_Trabajo_Ampliada.txt_id_cliente.Text = dgvLista_Orden_Trabajo.Item("CLI_id_cliente", dgvLista_Orden_Trabajo.SelectedRows(0).Index).Value 'numero orden
            ...
            Try
                frm_Orden_Trabajo_Ampliada.cboPiezas_Producto.SelectedValue = dgv_detalle_orden.Item("PIE_id_pieza", dgv_detalle_orden.SelectedRows(0).Index).Value
                frm_Orden_Trabajo_Ampliada.cboPiezas_Producto_Gran_Formato.SelectedValue = dgv_detalle_orden.Item("PIE_id_pieza_offset", dgv_detalle_orden.SelectedRows(0).Index).Value
            Catch ex As Exception
            End Try
        ...
        ElseIf frm_Orden_Trabajo_Ampliada.txtCantidad_1_Pliego_Maquina_Digital.TextLength <> 0 Then
            frm_Orden_Trabajo_Ampliada.chkDigital.Checked = False
            frm_Orden_Trabajo_Ampliada.chkOffset.Checked = False
            frm_Orden_Trabajo_Ampliada.chkGranFormato.Checked = False
            frm_Orden_Trabajo_Ampliada.chkTerminacion.Checked = False
            ...
            frm_Orden_Trabajo_Ampliada.LimpiarTerminacion()
            'End If
        ElseIf frm_Orden_Trabajo_Ampliada.txt_cantidad_producto_Gran_Formato.TextLength <> 0 Then
            frm_Orden_Trabajo_Ampliada.chkGranFormato.Checked = False
            frm_Orden_Trabajo_Ampliada.chkDigital.Checked = False
            frm_Orden_Trabajo_Ampliada.chkOffset.Checked = False
            frm_Orden_Trabajo_Ampliada.chkTerminacion.Checked = False
            ...
            'End If
            'CONTROLAR
        ElseIf frm_Orden_Trabajo_Ampliada.chkAdhesivado.Checked = True Then
            frm_Orden_Trabajo_Ampliada.chkTerminacion.Checked = False
